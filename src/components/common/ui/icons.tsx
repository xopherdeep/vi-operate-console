...
export interface IconLucideProps extends React.HTMLAttributes<HTMLDivElement> {
  name: string; // Name of the Lucide icon
  size?: 'xs' | 'sm' | 'md' | 'lg';
  className?: string;
  color?: string;
}
...
/**
 * A component that dynamically renders a Lucide icon by name
 */
