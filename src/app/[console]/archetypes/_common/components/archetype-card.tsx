          ...
          <div className="mt-4 pt-4 border-t border-gray-100 flex justify-end">
            ...
            {status === 'Paused' ? (
              <Button 
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  console.log(`Resume archetype ${id}`);
                  // Here you would call a function to resume the archetype
                  // For example: onStatusChange(id, 'Active')
                }}
              >
                Resume
              </Button>
              ...
              <Button 
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  console.log(`Pause archetype ${id}`);
                  // Here you would call a function to pause the archetype
                  // For example: onStatusChange(id, 'Paused')
                }}
              >
                Pause
              </Button>
